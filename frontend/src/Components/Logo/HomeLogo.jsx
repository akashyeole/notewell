...
import './HomeLogo.css'
import logoLight from '../../Images/logo_static_light.png';

const HomeLogo = () => {
    const [loaded, setLoaded] = useState(false);
    const [logoStateCounter, setLogoStateCounter] = useState(0);
    let i = 0;
    useEffect(()=>{
    ...
    useEffect(()=>{
        setTimeout(()=>{
            setLogoStateCounter((logoStateCounter+1)%4);
        }, 5000)
    }, [logoStateCounter]);

    return(
        loaded && <div className="home-page-logo-container">
            <img src={logoLight} className='home-page-main-logo ashadow'/>
            <div className="logo-item ashadow" id='lg1'>
                {logoStateCounter === 0 && <lord-icon
                    class= 'lordlg'
            ...
            {/* {logoStateCounter===1 && <><div className="logo-item ashadow" id='lg1'>
                <lord-icon
                    class= 'lordlg'
                    src="https://cdn.lordicon.com/xahjzcuv.json"
                    trigger="loop"
